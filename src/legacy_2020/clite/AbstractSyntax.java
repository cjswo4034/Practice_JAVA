...
class Indenter {
    ...
    public void display(String message) {
        ...
        for (int i = 0; i < depth; i++)
            sb.append("    ");
        System.out.print(sb.toString() + message);
    }
} // Indenter
...
class Declarations extends ArrayList<Declaration> {
    ...
    void display(int depth) {
        Indenter indent = new Indenter(depth);

        StringBuilder sb = new StringBuilder();
        sb.append(getClass().toString().substring(12) + ": \n");
        sb.append("        Declarations = { ");

        for (int i = 0, leng = this.size(); i < leng; i++) {
...
class Conditional extends Statement {
    ...
    public void display(int depth) {
        super.display(depth);
        test.display(depth + 1);
        thenbranch.display(depth + 1);
        assert elsebranch != null : "else branch cannot be null";
        elsebranch.display(depth + 1);
    }
}
